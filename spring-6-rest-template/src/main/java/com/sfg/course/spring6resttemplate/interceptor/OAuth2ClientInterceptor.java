package com.sfg.course.spring6resttemplate.interceptor;
...
public class OAuth2ClientInterceptor implements ClientHttpRequestInterceptor {
    ...
    @Autowired
    public OAuth2ClientInterceptor(final OAuth2AuthorizedClientManager manager, final ClientRegistrationRepository clientRegistrationRepository) {
